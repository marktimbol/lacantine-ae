...
function ht_get_portfolio_options() {
    ...
    $custom_portfolio_meta_fields = array(
        ...
        array(
            'label'=> __('Point your featured image to an external URL', 'highthemes'),
            'desc'  => __('if you want to link your image (in the gallery page) to an external URL, type it here below. Otherwise, leave the field empty.', 'highthemes'),
