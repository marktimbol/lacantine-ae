...
if( ! function_exists('ht_include_google_font') ){
    function ht_include_google_font() {
        ...
        if( substr($font['face'], 0, 6) == 'google' ){
            ...
            wp_enqueue_style( 'custom-heading-fonts', 'https://fonts.googleapis.com/css?family='.$font['face'].$latin_chars);
        ...
        if( substr($font_nav['face'], 0, 6) == 'google' ){
            ...
            wp_enqueue_style( 'custom-navigation-fonts', 'https://fonts.googleapis.com/css?family='.$font_nav['face'].$latin_chars);
        ...
        if( substr($font_body['face'], 0, 6) == 'google' ){
            ...
            wp_enqueue_style( 'custom-body-fonts', 'https://fonts.googleapis.com/css?family='.$font_body['face'].$latin_chars);
        ...
        if( substr($font_sidebar['face'], 0, 6) == 'google' ){
            ...
            wp_enqueue_style( 'custom-sidebar-fonts', 'https://fonts.googleapis.com/css?family='.$font_sidebar['face'].$latin_chars);
