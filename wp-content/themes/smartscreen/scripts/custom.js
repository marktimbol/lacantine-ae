...
jQuery(document).ready(function ($) { //#Begin
    ...
    $('.entries-toggle').click(function(){
	    ...
	    /*** [RAJOUT FUSIOLINE POUR FERMER A L'OUVERTURE] ***/

  /* $( document ).ready(function() {  $  */
   /*   $('.entries-toggle').ready(function(){
	  ...
	  var sidebar_height = $('#sidebar').height() + 50;
        if($(this).attr('data-active') == 'yes') {
            ...
            $('#sidebar').stop(true, true).animate({top:-sidebar_height}, '5000', 'swing');
            $(this).attr('data-active', 'no');
			 $('i.arrow-toggle').attr('data-active', 'yes');
					 $('i.entries-toggle').attr('data-active', 'yes');
	 ...
	 /*	var largeur_fenetre = $(window).width();
      ...
      $('#sidebar').slideUp();
            ...
            $('#menu-wrap').stop(true, true).animate({top:0}, '5000', 'swing');
            $(this).attr('data-active', 'no');
			  $('.arrow-toggle').attr('data-active', 'yes'); 
			  			  $('.entries-toggle').attr('data-active', 'yes');       
      
		}}
});*/
	    /*** end [RAJOUT FUSIOLINE POUR FERMER A L'OUVERTURE] ***/
...
/*    selectnav('main-menu', {
    ...
    // Responsive
    $("#mobile-nav").before('<div id="mobilepro"><i class="fa fa-reorder fa-times"></i> MENU </div>');
